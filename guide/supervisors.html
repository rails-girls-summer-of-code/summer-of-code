...
<p>So you'd like to get involved, but you don't have any experience in coaching? Maybe you'd like to be a supervisor instead? Read below to see if it fits your profile. 
...
<p>A supervisor is the "glue" between the Rails Girls Summer of Code orga-team and the full team (students, coaches, and project mentors) they are assigned. This is why we require them to regularly communicate with coaches and students; we suggest a short call once a week, to make sure everything is going smoothly. They should check on the students and their progress often, this includes checking eg. the daily log and making sure that things are going forward, as well as lending an ear to the students in those frustrating moments.</p>
...
<p>Of course! Supervisors aren't required to have technical skills or answer code-related questions - that's what the coaches and our help desk are for. It's useful if you have a bit of knowledge when it comes to some of the tools we use, like GitHub, as you might have to check on commits or pull requests.</p>

<h3 id="time">How much time does being a supervisor take?</h3>

<p>Being a supervisor means committing for the 3 months of the Rails Girls Summer of Code; you should be able to put aside on average half an hour a day for 3 to 5 days a week.</p>

<h3 id="apply">How can I apply?</h3>

<p>The best way is to just drop us a line at <a href="mailto:summer-of-code@railsgirls.com">summer-of-code@railsgirls.com</a> telling us you want to help out!</p>