...
For further information on finding a teammate we have prepared a [detailed guide](https://railsgirlssummerofcode.org/students/finding-your-team) for you.
...
Our [guide for Coaches](https://railsgirlssummerofcode.org/guide/coaching) will help to give you insight on what is required of them, and help you to explain this to prospective coaches. For further information on how to find coaches, we have also prepared a [a detailed guide](https://railsgirlssummerofcode.org/students/finding-your-team).

<h4 id="office">A place to work

You will need an environment suitable for working on your project for 3 months. This could be your home, a co-working space, your current work office or a [Coaching Company](https://railsgirlssummerofcode.org/guide/coaching-company). As long as you are safe and productive, you can choose where you will work.
...
<h4 id="motivate">The ability to self-manage and motivate
...
<h4 id="project">A project

You must select a [project from the list](https://teams.railsgirlssummerofcode.org/projects) of those approved for RGSoC 2020. This will be published in February.
...
1. go to the [Teams page](https://teams.railsgirlssummerofcode.org/teams)
2. click on “New Team”
3. add your team members (teammate and coaches)
4. save your team
5. clicking “Apply now” in the navigation to visit the application form.

The application form is split into three sections, where you will be asked:
1. questions about yourself, your experience with coding so far, and other information that is relevant to our decision-making process. You and your teammate will fill in this information separately
2. to select your chosen (and second choice) project from a drop-down menu
3. about your team setup. Do this together as a team
...
If you have any queries about the application process, please [send us an email](mailto:contact@rgsoc.org).
...
* Choice of project - we can often only assign one team to each project. The more teams that choose the same project, the stiffer the competition may be. You can see how many teams applied to which projects [here](https://teams.railsgirlssummerofcode.org/projects) and we recommend you select a second choice.

<h3 id="during"Requirements during the program</h3>

RGSoC focuses on students learning to code but is also a community event. Along with this application guide, please also read about [what will be asked of you](http://railsgirlssummerofcode.org/students/todo) during the program.

Students have to agree with the following requirements and, in case of being selected, must sign a written agreement:
* Participate full-time from 01 July to 30 September 2020
* Continuously work on the chosen and approved Open Source project
* Keep track of your work with a short, [daily summary](https://railsgirlssummerofcode.org/students/log)
...
For further insight on this or for setting up a good working environment, please read [“What to expect”](http://railsgirlssummerofcode.org/students/todo), where we gathered suggestions and recommendations for students. We strongly advise you to get acquainted with these requirements before making an application. We will make sure they are complied with and will take steps in case of breaches.

If you have any questions about the above list, please [send us an email](mailto:contact@rgsoc.org).
...
* Can you commit to working on your project full time for 3 months (July-Sept)?
...
If you need help setting up your application, go to the “Help” Section on our [Teams page](https://teams.railsgirlssummerofcode.org/pages/help).

<h3 id="questions">Still got questions?</h3>

That's okay. Just [send us an email](mailto:contact@rgsoc.org).
